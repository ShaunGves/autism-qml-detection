...
A hybrid **Quantum-Classical** model that detects autism from facial images using a **Quanvolution** layer (PennyLane) followed by a clasical dense neural network (TensorFlow/Keras).
